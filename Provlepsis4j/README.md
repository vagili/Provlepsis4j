...
# Neo4j UI: http://localhost:7474 (neo4j / please_change_me)
```
In the UI:
...
## Notes
- For **AuraDS**, leave Docker Neo4j off and point the backend to Aura via `.env`.
- Secure the backend (JWT, CORS, rate limits) before exposing publicly.
- GraphSAGE/HashGNN availability depends on your GDS version/edition.
