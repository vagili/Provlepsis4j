...
# ---- Optional feature helpers (robust import) --------------------------------
try:
    from . import feature as _feature_mod  # your app/routers/feature.py module
    _FEATURES_OK = True
except Exception:
    _feature_mod = None
    _FEATURES_OK = False
...
def _auto_prepare_features(coverage: float = 1.0, max_categories: int = 256) -> Dict[str, Any]:
    ...
    if _FEATURES_OK and _feature_mod is not None:
        ...
        # module path didn’t yield props -> fall back locally
